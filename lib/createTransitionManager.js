...
function createTransitionManager(history, routeMatcher, section) {
  var state = {};
  ...
  function match(location, callback) {
    if (partialNextState && partialNextState.location === location) {
      ...
      var nextState = (0, _locationToState2.default)(routeMatcher, location, section);
      if (nextState) {
